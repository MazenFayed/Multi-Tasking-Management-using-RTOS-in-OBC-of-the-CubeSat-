...
//Header Files
#include "stm32f446xx_driver.h"//depending on your board
#include <string.h>
...
//2- i2c Read
void I2C_Read(I2C_Handle_t I2C1Handle,uint8_t ADDR, uint8_t *i2cBuf, uint8_t NofData);
//3- i2c Write 8 Bit
